function table_MTs = list_tasks_recon3(model,thermo_data)
...
task_should_fail = 0;
task_mets_in = {'o2_e';'glc_D_e';'nh4_e';'pi_e'};
...
task_should_fail = 0;
task_mets_in = {'o2_e';'glc_D_e';'pi_e'};
...
task_mets_out_lb = [0.001;NaN;NaN];
task_mets_out_ub = [NaN;NaN;NaN];
task_rxns = {};
task_rxns_lb = [];
...
task_should_fail = 0;
task_mets_in = {'o2_e';'glc_D_e';'nh4_e';'h2o_e';'arg_L_e';'his_L_e';'lys_L_e';...
...
task_mets_in_ub = [NaN;NaN;NaN;NaN;NaN;NaN;NaN;NaN;NaN;NaN;NaN;NaN;NaN;NaN;...
                   NaN;NaN;NaN;NaN;NaN;NaN;NaN;NaN;NaN];%;NaN];
task_mets_out = {'albumin_c';'co2_e';'h2o_e';'urea_e'};
task_mets_out_lb = [0.001;NaN;NaN;NaN;NaN];
...
task_should_fail = 0;
task_mets_in = {'succ_m';'nadh_m';'h_m';'h_i';'o2_e'};
task_mets_in_lb = [1;1;1;1;NaN];
task_mets_in_ub = [1;1;1;1;NaN];
...
task_mets_in_lb = [1;NaN;NaN];
task_mets_in_ub = [1;NaN;NaN];
task_mets_out = {'q10_m';'h2o_e';'h_m';'h_i'};
task_mets_out_lb = [1;NaN;NaN;NaN];
task_mets_out_ub = [1;NaN;NaN;NaN];
task_rxns = {'atp_m + h2o_m <=> adp_m + pi_m + h_m'};
task_rxns_lb = 1;
...
task_should_fail = 0;
task_mets_in = {'chol_e';'glc_D_e';'o2_e';'pi_e';'lnlc_e'};%'lnlnca_e'};
...
task_should_fail = 0;
task_mets_in = {'ser_L_e';'glc_D_e';'o2_e';'pi_e';'lnlc_e'};%'lnlnca_e'};%;'ethanolamine};
...
task_should_fail = 0;
task_mets_in = {'ser_L_c';'glc_D_e';'o2_e';'pi_e';'lnlc_e'};%'lnlnca_e'};
task_mets_in_lb = [NaN;NaN;NaN;NaN;NaN;NaN];
task_mets_in_ub = [NaN;NaN;NaN;NaN;NaN;NaN];
...
task_should_fail = 0;
task_mets_in = {'glc_D_e';'o2_e';'pi_e';'lnlc_e'};%'lnlnca_e';'inost_e'};
task_mets_in_lb = [NaN;NaN;NaN;NaN;NaN;NaN];
task_mets_in_ub = [NaN;NaN;NaN;NaN;NaN;NaN];
...
task_should_fail = 0;
task_mets_in = {'pnto_R_e';'cys_L_e';'glc_D_e';'o2_e';'h2o_e';'pi_e';'nh4_e'};
task_mets_in_lb = [NaN;NaN;NaN;NaN;NaN;NaN;NaN];
task_mets_in_ub = [NaN;NaN;NaN;NaN;NaN;NaN;NaN];
...
task_should_fail = 0;
task_mets_in = {'o2_e';'glc_D_D_e';'nh4_e';'pi_e';'ribflv_e'};
...
task_should_fail = 0;
task_mets_in = {'o2_e';'nh4_e';'glc_D_e';'fe2_e'};
task_mets_in_lb = [NaN;NaN;NaN;NaN];
task_mets_in_ub = [NaN;NaN;NaN;NaN];
...
%                 %'aqcobal_e';'lipoate_e';...
%                 'glc_D_e';'so4_e';'lnlc_e';'lnlnca_e';'lnlc_e';'lnlnca_e';...
